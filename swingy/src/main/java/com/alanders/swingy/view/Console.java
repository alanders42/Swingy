...
import com.alanders.swingy.model.Hero;
import com.alanders.swingy.utils.Tools;
import com.alanders.swingy.controller.Map;
...
public class Console implements ViewMode {
    ...
    public void createHero(Scanner sc){
        ...
        try {
            ...
            System.out.print("Name your Class: ");
            heroClass = sc.nextLine();
            
            System.out.print("Enter any Level (Integer between 1 - 5): ");
            level = sc.nextInt();
            // if ((level < 1) || (5 < level))
            //     throw new Exception();
            sc.nextLine(); // Moving Cursor
            
            System.out.print("Enter Experience (Integer between 0-50): ");
            experience = sc.nextLong();
            sc.nextLine(); // Moving Cursor
            
            System.out.print("Enter Attack (Integer between 0-50): ");
            attack = sc.nextInt();
            sc.nextLine(); // Moving Cursor
            
            System.out.print("Enter Defence (Integer between 0-50): ");
            defence = sc.nextInt();
            sc.nextLine(); // Moving Cursor
            
            System.out.print("Enter Hit Points (Integer between 0-50): ");
